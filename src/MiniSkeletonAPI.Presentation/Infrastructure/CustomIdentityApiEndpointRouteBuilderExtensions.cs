...
using static Microsoft.AspNetCore.Routing.CustomIdentityApiEndpointRouteBuilderExtensions;
...
public static class CustomIdentityApiEndpointRouteBuilderExtensions
{
        ...
        where TUser : class, new()
    {
        ...
        //    ([FromBody] LoginRequest login, [FromQuery] bool? useCookies, [FromQuery] bool? useSessionCookies, [FromServices] IServiceProvider sp, IIdentityService identityService) =>
        //{
        ...
        //    var user = await identityService.GetByNikAsync(login.Nik);
        //    var userManager = sp.GetRequiredService<UserManager<TUser>>();
 ...
 //               var user = await identityService.GetByNikAsync(login.Nik);
 //               var domainUser = await identityService.GetByNikAsync(login.Nik);

 //               var userManagers = sp.GetRequiredService<UserManager<ApplicationUser>>();
 //               var identityUser = await userManagers.FindByNameAsync(domainUser.UserName);
 //               var result = await signInManager.PasswordSignInAsync(user.UserName, login.Password, isPersistent, lockoutOnFailure: true);
 ...
 //               if (result.Succeeded)
 //               {
 //                   //var token = GenerateJwtToken(identityUser, configuration);
 //                   //return Results.Problem("Login gagal: " + token);
 ...
 //           {
 //               // Log jika perlu
 //               return Results.Problem("Login gagal: " + ex.Message);
 //           }
 //       });
